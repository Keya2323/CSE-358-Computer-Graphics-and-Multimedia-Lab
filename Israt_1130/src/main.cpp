...
int main()
{
    ...
    // window name: "Israt Jahan Keya-1130"
    // --------------------
    ...
    float vertices[] = {
    //Triangle-1
    -0.80f,  0.40f, 0.0f,   // left base
    -0.30f,  0.40f, 0.0f,   // right base
    -0.95f,  0.80f, 0.0f,   // top    
    //Triangle-2
    0.80f,  -0.80f, 0.0f,   // left base
    0.30f,  -0.80f, 0.0f,   // right base
    0.95f,  -0.40f, 0.0f    // top
    }; 
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glDrawArrays(GL_TRIANGLES, 0, 6); //0 starting index, 6 no. of vertices
...
// pressing "I" will close the window
// ---------------------------------------------------------------------------------------------------------
void processInput(GLFWwindow *window)
{
