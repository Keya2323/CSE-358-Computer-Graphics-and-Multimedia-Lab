...
const char *fragmentShaderSource = "#version 330 core\n"
    ...
    "void main()\n"
    "{\n"
    "   FragColor = ourColor;\n" /*The color is passed as a uniform variable, which can be changed from CPU side.
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Israt Jahan Keya 1130", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform4f(vertexColorLocation, 1.0f, redvalue, redvalue, 1.0f);
...
// Scale the rectangle over time
        ...
        transform = glm::rotate(transform,(float)glfwGetTime(), glm::vec3(1.0f, 1.0f, 0.0f));//0, 0, 1) means rotate around the Z-axis, which is perpendicular to the screen.In 2D, this gives the impression of spinning in place.
